...
use crate::errors::{EngineError, InfrastructureStep, Stage};
use crate::logs::{EngineEvent, LogLevel, LogManager, Logger, State};
use crate::models::{
    ...
    pub fn new(
        ...
        for node_group in &nodes_groups {
            if let Err(e) = ScwInstancesType::from_str(node_group.instance_type.as_str()) {
                ...
                log_manager.log(LogLevel::Error, EngineEvent::new(State::Error, Some(err.clone())));
