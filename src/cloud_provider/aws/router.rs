...
use crate::error::{cast_simple_error_to_engine_error, EngineErrorCause, EngineErrorScope, LegacyEngineError};
...
impl Pause for Router {
    #[named]
    fn on_pause(&self, _target: &DeploymentTarget) -> Result<(), LegacyEngineError> {
